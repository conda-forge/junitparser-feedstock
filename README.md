...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/junitparser-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/junitparser-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add junitparser
# for installing globally
pixi global install junitparser
```
...
It is possible to list all of the versions of `junitparser` available on your platform:
...
```
pixi search junitparser --channel conda-forge
```
